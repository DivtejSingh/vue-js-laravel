    ...
    <div>
        ...
        <v-row class="mt-0 pt-0 gap-2 flex-nowrap w-100 justify-content-between search-products">
            ...
            <v-col cols="12" md="1" class="p-0">
                <v-btn color="secondary" small :to="'/admin/product/addview'" router class="text-none fw-bold" style="height: 32px; color: #1976d2; background-color: white !important; border: 1px solid #1976d2 !important;">
                    Add Product
                </v-btn>
            </v-col>
        </v-row>
