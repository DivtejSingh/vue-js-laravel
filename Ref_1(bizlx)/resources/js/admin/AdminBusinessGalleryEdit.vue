<template>
  <div class="pa-2">
    ...
    <v-form ref="form" v-model="valid" lazy-validation>
          ...
          <v-btn class="my-2 ms-4" color="error" v-if="userdata.id != null"  @click="addgalleryImagebyreseller">ADD IMAGE</v-btn>
          <v-btn class="my-2 ms-4" color="error" v-else  @click="addgalleryImage">ADD IMAGE</v-btn>
    </v-form>
    <div class="py-4">
...
export default {
  ...
  user_id() {
    ...
    getGalleryimages() {
      axios.post('/api/gallery/imagesbyadmin', { userId: this.user_id() })
          .then((resp) => {
    ...
    addgalleryImage(){
      ...
      if(this.image_url != ''){
        axios.post('/api/add/business/gallery_images1',data, config)
            .then((resp) =>{
              this.snackbar = true;
              this.timeout = 3000;
    ...
    addgalleryImagebyreseller(){
      ...
      if(this.image_url != ''){
        axios.post('/api/reseller/add/business/gallery_images1',data, config)
            .then((resp) =>{
              this.snackbar = true;
              this.timeout = 3000;
              this.text = resp.data.message;
