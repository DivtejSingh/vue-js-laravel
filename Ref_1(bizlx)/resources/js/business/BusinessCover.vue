<template>
  ...
  <!--              </v-col>-->
            ...
            <v-btn class="my-4 ms-4" color="error" v-else :disabled="!valid" @click="addcoverImage">ADD IMAGE</v-btn>
          </v-form>
      <div class="py-4">
  ...
  export default {
    ...
    methods: {
      ...
      addcoverImage(){
        ...
        if(this.image_url != ''){
          axios.post('/api/add/business/cover_images',data, config)
              .then((resp) =>{
                this.snackbar = true;
                this.timeout = 3000;
