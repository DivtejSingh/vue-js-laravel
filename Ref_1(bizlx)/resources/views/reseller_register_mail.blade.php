							...
							<table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
								<tr>
									<td style="color:#153643;">
										<h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Dear Reseller,</h1>
										<p style="margin:0 0 10px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Welcome to Bizlx, Here are your details.</p>
									</td>
								</tr>
								<tr>
									<td style="color:#153643;padding-left:10px;">
										<p style="margin:0 0 0px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Name: {{ $name }}</p>
										<p style="margin:0 0 0px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Mobile No.: {{ $phone }}</p>
										<p style="margin:0 0 0px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Email: {{ $email }}</p>
										<p style="margin:0 0 0px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Password: {{ $password }}</p>
										<p style="margin:0 0 0px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Login link: <a href="{{$base_url}}/reseller/login">{{$base_url}}/reseller/login</a></p>
									</td>
								</tr>
								<tr>
									<td style="color:#153643;">
										<p style="margin:10 0 0px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Thanks!</p>
									</td>
								</tr>
