...
<head>
    ...
    <meta name=author content="Bizlx.com">
    <meta name="description" content="Bizlx.com™ is India's daily local hot deals, sales, and latest information website of shops and stores. Search hotels, shops,
garments, furniture, jewelry, automobiles, professionals, mobile phones, restaurants with reviews &amp;amp; discounts on shopping &amp;amp; product videos everyday. Bizlx provides local, accurate &amp;amp; verified business information to customers with regular updates.">
    <meta name="keywords" content="Bizlx,bizlx hot deals,Bizlx hotel deals,Bizlx daily deals website,India Daily Hot Deals Website,resort deals bizlx,Bizlx Founder Rajneesh Sharma,Products,Professional,Professionals,Local Hot Deals,promotion website,cottages listed on bizlx,Bizlx discounts,Leading Hotels in Bizlx">
    ...
    <meta property="og:title" content="Bizlx.com™   Search Daily Local Hot Deals, Sales, Latest Arrivals, Videos of Shopping Stores Around You">
    <meta property="og:description" content="Bizlx.com™ is India's daily local hot deals, sales, and latest information website of shops and stores. Search hotels, shops,
garments, furniture, jewelry, automobiles, professionals, mobile phones, restaurants with reviews &amp;amp; discounts on shopping &amp;amp; product videos everyday. Bizlx provides local, accurate &amp;amp; verified business information to customers with regular updates.">
    ...
    <title>Comming Soon | {{$title}} Bizlx.com™ </title>
...
<div class=container>
    <div class=row>
        ...
        <div class="col-12 col-md-7 right">
            <div class=mainInfo>
                <img src="{{asset('https://cdn.bizlx.com/images/logo.png')}}" alt="Bizlx" width="78">
                <h2>COMING SOON</h2>
                <p class=slogan>Bizlx.com™ - Daily Market Update, Hot Deals, Shopping, Sales</p>
{{--                <form class=form-subscribe action=#> --}}
{{--                    <input type=email class=form placeholder="Your email address"--}}
{{--                                                            required> --}}
{{--                    <button type=submit>Subscribe</button> --}}
{{--                </form>--}}
            </div>
            <ul class=icon-list>
                <li class=icon><a class=twitters href="https://twitter.com/bizlx_">
                        <img src="https://cdn.bizlx.com/images/twitter-logo.png" alt="Facebook" width="35">
                    </a></li>
                <li class=icon><a class=linkedins href="https://www.linkedin.com/company/bizlx/">
                        <img src="https://cdn.bizlx.com/images/linkedin-logo.png" alt="Facebook" width="35">
                    </a></li>
                <li class=icon><a class=facebooks href="https://www.facebook.com/bizlx">
                        <img src="https://cdn.bizlx.com/images/facebook-logo.png" alt="Facebook" width="35">
                    </a></li>
                <li class=icon><a class=instagrams href="https://www.instagram.com/bizlx_/">
                        <img src="https://cdn.bizlx.com/images/instagram-logo.png" alt="Facebook" width="35">
                    </a></li>
                <li class=icon><a class=youtubes href="https://www.youtube.com/@bizlxtv">
                        <img src="https://cdn.bizlx.com/images/youtube-logo.png" alt="Facebook" width="35">
                    </a></li>
            </ul>
        </div>
    </div>
...
-------------------------------------------------------------------*/
    ...
    .container .row .left-wrap .left {
        background-image: url(https://cdn.bizlx.com/images/247.jpg);
...
<script type="text/javascript">
    var yourDate = "2024-08-07" // Your date here
    ! function (e) {
        var t = {};
