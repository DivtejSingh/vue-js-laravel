...
<p> {{$username}} is raised a query regarding to your business.</p>
Thanks & Regards,
Bizlx
<!DOCTYPE html>
							...
							<table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
								<tr>
									<td style="color:#153643;">
										...
										<p style="margin:0 0 10px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><b>{{$username}}</b> is raised a query regarding to your business.</p>
                                        <card>
                                            <card-body>
                                                <p style="margin:0 0 10px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                                    {{$description}}</p>
                                            </card-body>
                                        </card>

										<p style="margin:0 0 0px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Thanks!</p>
									</td>
								</tr>
