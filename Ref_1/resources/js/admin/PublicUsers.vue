<template>
    <div class="pa-2">
        ...
        <div class="my-5">
            <v-data-table :search="search" :headers="headers" :items="usersdata" sort-by="calories" class="elevation-1" items-per-page="10">
                <template v-slot:top>
                    ...
                    <v-dialog v-model="deletemultipleusers" max-width="500px">
                        <v-card>
                            ...
                            <v-card-actions>
                                ...
                                <v-btn v-else class="cred" text @click="multipleUsersIds" >OK</v-btn>
                                <v-spacer></v-spacer>
                            </v-card-actions>
                        </v-card>
                    </v-dialog>
    ...
    methods: {
        ...
        submitUserUpdate() {
            ...
            if (this.editedIndex > -1) {
                ...
                axios.post("/api/admin/user/update", data, config)
                    .then((resp) => {
                        this.snackbar = true;
                        this.text = resp.data.message;
                        this.timeout = 3000;
        ...
        multipleUsersIds(){
            ...
            axios.post('/api/delete/multiple/users', data)
                .then((resp) => {
                    if(resp.data.success == true){
