    ...
    <div class="pa-2">
      ...
      <v-form ref="form" v-model="valid" lazy-validation>
            <v-row>
              ...
              <v-col cols="12" md="12" class="py-0">
                <v-text-field v-model="image_title" label="Title"></v-text-field>
              </v-col>
              <v-col cols="12" md="12" class="py-0">
            ...
            <v-btn class="my-2 ms-4" color="error" v-else :disabled="!valid" @click="addgalleryImagebyreseller">ADD IMAGE</v-btn>
      </v-form>
      <div class="py-4">
                ...
                <v-dialog v-model="dialog" max-width="500px">
                  <v-card>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn class="success" v-if="userdata.id != null" text @click="editgalleryImagebyreseller">
                        Update
                      </v-btn>
                      <v-btn class="success" text v-else @click="editgalleryImagebyreseller">
                        Update
                      </v-btn>
                    </v-card-actions>
                  </v-card>
                ...
                <v-dialog v-model="dialogDelete" max-width="500px">
                  <v-card>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn  class="error" v-if="userdata.id != null" text @click="deleteGalleryimagebyreseller">Delete</v-btn>
                      <v-btn  class="error" v-else text @click="deleteGalleryimagebyreseller">Delete</v-btn>
                      <v-spacer></v-spacer>
                    </v-card-actions>
                  </v-card>
                </v-dialog>
